...
fn ea_main(file: &str, params: usize, n_s: usize, plotctrl: bool, savectrl: bool, normback: bool, noback: bool, ntryes: u64)
{
    ...
    match params
    {
        ...
        8 => {
            ...
            para = vec![0.001515220623971926, 95.3617522532079, 29.71628770521993, 0.018173813714234245, 0.4070452627059803, 63.551869486348686, 0.28633564773775666, 0.2728121871710092];
